Public Class UpdateForm
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If MessageBox.Show("Are you sure You want to update ID No " & dGrid.CurrentRow.Cells("ID").Value.ToString() & "?", "Update Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = 6 Then
    ...
    Private Sub UpdateForm_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Main.Enabled = True
